...
namespace lubo2012.UI
{
    public partial class MainForm : Form
    {
        ...
        private void LoadConfig()
        {
            ...
            sbRecordScreen.Value = xd.SelectSingleNode("/config/studentRtspSource/videoInput").InnerText == "1" ? true : false;
        ...
        {
            GetAudioInputCount();
            if (!sbRecordScreen.Value && sbStuAudioInput.Value)
        ...
        private void btnSettingSave_Click(object sender, System.EventArgs e)
        {
        ...
        private void btnSettingCancel_Click(object sender, System.EventArgs e)
        {
        ...
        private void plVideoTab_Click(object sender, EventArgs e)
        {
            plRecordTab.BackgroundImage = Resources.录播_默认;
            plVideoTab.BackgroundImage = Resources.视频管理_选中;
            //ShowPreview();
        }

        private void plRecordTab_Click(object sender, EventArgs e)
        {
            plRecordTab.BackgroundImage = Resources.录播_选中;
            plVideoTab.BackgroundImage = Resources.视频管理_默认;
            //ShowVideoList();
        }
