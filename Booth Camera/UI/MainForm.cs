...
namespace AeroEduClass.UI
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            {
                // 缩放面板
                plCamera.Controls.Add(this.plZoom);
                plZoom.Location = new Point(0, plCamera.Height - plZoom.Height);
                // 画笔面板
                plCamera.Controls.Add(this.plPenPopsetting);
                plPenPopsetting.Location = new Point(215, plCamera.Height - plPenPopsetting.Height);
                // 橡皮擦面板
                plCamera.Controls.Add(this.plEraser);
                plEraser.Location = new Point(215, plCamera.Height - plEraser.Height);
